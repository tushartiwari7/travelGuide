    ...
    <div className="App">
      <div className="bg-warning">
        <h1 className="heading display-4">
          explore <span style={{ color: 'teal', fontSize: '1.2em', fontWeight: '600' }}>chandigarh</span>
        </h1>
        <Dropdown foodInputHandler={foodInputHandler} />
        <hr />
      </div>
      ...
      <div className="credits">
        ...
        by <a href="https://www.linkedin.com/in/tushartiwari0172/"> Tushar Tiwari.</a>
      </div>
    </div>
  );
}
